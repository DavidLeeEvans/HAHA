...
HXLINE(  19)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("HAHA",32,ee,c8,2f),::ApplicationMain_obj::create_dyn());
...
HXLINE(  42)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("com.davidevans.games.haha",bf,46,f1,ba));
...
HXLINE(  49)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("HAHA",32,ee,c8,2f))
