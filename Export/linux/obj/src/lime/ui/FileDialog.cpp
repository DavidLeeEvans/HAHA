...
HXLINE( 118)					path = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_open_file(title1->__get(0),filter,defaultPath);
HXLINE( 122)					worker->sendComplete(( ( ::Dynamic)(path) ));
            				}
            				break;
            				case (int)1: {
HXLINE( 126)					if (::hx::IsNull( title1->__get(0) )) {
HXLINE( 126)						title1[0] = HX_("Open Files",a1,d5,ea,6e);
            					}
...
HXLINE( 179)					path = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_save_file(title1->__get(0),filter,defaultPath);
HXLINE( 183)					worker->sendComplete(( ( ::Dynamic)(path) ));
            				}
            				break;
            				case (int)3: {
HXLINE( 150)					if (::hx::IsNull( title1->__get(0) )) {
HXLINE( 150)						title1[0] = HX_("Open Directory",97,c6,32,a3);
            					}
HXLINE( 153)					 ::hx::Object * path = ::hx::DynamicPtr(null());
HXLINE( 159)					path = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_open_directory(title1->__get(0),filter,defaultPath);
...
HXLINE( 251)			if (::hx::IsNull( title1->__get(0) )) {
HXLINE( 251)				title1[0] = HX_("Open File",92,6a,32,1d);
            			}
HXLINE( 254)			 ::hx::Object * path = ::hx::DynamicPtr(null());
HXLINE( 260)			path = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_open_file(title1->__get(0),filter,defaultPath);
...
HXDLIN( 244)		::Array< ::String > title1 = ::Array_obj< ::String >::__new(1)->init(0,title);
...
HXLINE( 248)		worker->doWork->add( ::Dynamic(new _hx_Closure_0(worker,filter,title1,defaultPath)),null(),null());
...
HXLINE( 321)			if (::hx::IsNull( title1->__get(0) )) {
HXLINE( 321)				title1[0] = HX_("Save File",3f,02,ba,38);
            			}
HXLINE( 324)			 ::hx::Object * path = ::hx::DynamicPtr(null());
HXLINE( 330)			path = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_save_file(title1->__get(0),filter,defaultPath);
...
HXDLIN( 308)		::Array< ::String > title1 = ::Array_obj< ::String >::__new(1)->init(0,title);
...
HXLINE( 318)		worker->doWork->add( ::Dynamic(new _hx_Closure_0(worker,filter,title1,defaultPath)),null(),null());
