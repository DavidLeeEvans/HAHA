...
HXLINE(  78)		if (::hx::IsNull( ::lime::_hx_system::Clipboard_obj::_text )) {
HXLINE(  80)			::lime::_hx_system::Clipboard_obj::_hx___update();
HXLINE(  84)			::lime::_hx_system::Clipboard_obj::set_text(::lime::_hx_system::Clipboard_obj::_text);
            		}
