...
HX_LOCAL_STACK_FRAME(_hx_pos_83cd509ada000571_38_load,"cpp.Lib","load",0xd2b2dcba,"cpp.Lib.load","/home/david/bin/haxe/std/cpp/Lib.hx",38,0x839a89f6)
HX_LOCAL_STACK_FRAME(_hx_pos_83cd509ada000571_66_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/home/david/bin/haxe/std/cpp/Lib.hx",66,0x839a89f6)
HX_LOCAL_STACK_FRAME(_hx_pos_83cd509ada000571_70_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/home/david/bin/haxe/std/cpp/Lib.hx",70,0x839a89f6)
HX_LOCAL_STACK_FRAME(_hx_pos_83cd509ada000571_71_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/home/david/bin/haxe/std/cpp/Lib.hx",71,0x839a89f6)
HX_LOCAL_STACK_FRAME(_hx_pos_83cd509ada000571_72_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/home/david/bin/haxe/std/cpp/Lib.hx",72,0x839a89f6)
HX_LOCAL_STACK_FRAME(_hx_pos_83cd509ada000571_73_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/home/david/bin/haxe/std/cpp/Lib.hx",73,0x839a89f6)
HX_LOCAL_STACK_FRAME(_hx_pos_83cd509ada000571_74_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/home/david/bin/haxe/std/cpp/Lib.hx",74,0x839a89f6)
HX_LOCAL_STACK_FRAME(_hx_pos_83cd509ada000571_75_loadLazy,"cpp.Lib","loadLazy",0x865efe4e,"cpp.Lib.loadLazy","/home/david/bin/haxe/std/cpp/Lib.hx",75,0x839a89f6)
namespace cpp{
...
bool Lib_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic Lib_obj::load(::String lib,::String prim,int nargs){
            	HX_STACKFRAME(&_hx_pos_83cd509ada000571_38_load)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Lib_obj,load,return )
 ...
 ::Dynamic Lib_obj::loadLazy(::String lib,::String prim,int nargs){
            	HX_STACKFRAME(&_hx_pos_83cd509ada000571_66_loadLazy)
HXDLIN(  66)		try {
...
HXLINE(  69)				switch((int)(nargs)){
            					case (int)0: {
            						HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_1, ::Dynamic,e) HXARGC(0)
            						 ::Dynamic _hx_run(){
            							HX_STACKFRAME(&_hx_pos_83cd509ada000571_70_loadLazy)
            					...
            					case (int)2: {
            						HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_2, ::Dynamic,e) HXARGC(2)
            						 ::Dynamic _hx_run( ::Dynamic _, ::Dynamic _1){
            							HX_STACKFRAME(&_hx_pos_83cd509ada000571_71_loadLazy)
            					...
            					case (int)3: {
            						HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_3, ::Dynamic,e) HXARGC(3)
            						 ::Dynamic _hx_run( ::Dynamic _, ::Dynamic _1, ::Dynamic _2){
            							HX_STACKFRAME(&_hx_pos_83cd509ada000571_72_loadLazy)
            					...
            					case (int)4: {
            						HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_4, ::Dynamic,e) HXARGC(4)
            						 ::Dynamic _hx_run( ::Dynamic _, ::Dynamic _1, ::Dynamic _2, ::Dynamic _3){
            							HX_STACKFRAME(&_hx_pos_83cd509ada000571_73_loadLazy)
            					...
            					case (int)5: {
            						HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_5, ::Dynamic,e) HXARGC(5)
            						 ::Dynamic _hx_run( ::Dynamic _, ::Dynamic _1, ::Dynamic _2, ::Dynamic _3, ::Dynamic _4){
            							HX_STACKFRAME(&_hx_pos_83cd509ada000571_74_loadLazy)
            					...
            					default:{
            						HX_BEGIN_LOCAL_FUNC_S1(::hx::LocalFunc,_hx_Closure_0, ::Dynamic,e) HXARGC(1)
            						 ::Dynamic _hx_run( ::Dynamic _){
            							HX_STACKFRAME(&_hx_pos_83cd509ada000571_75_loadLazy)
