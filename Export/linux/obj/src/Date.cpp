...
HX_DEFINE_STACK_FRAME(_hx_pos_4a7af0c97c8b7a70_26_new,"Date","new",0x9aa26240,"Date.new","/home/david/bin/haxe/std/cpp/_std/Date.hx",26,0xbabcdf82)
HX_LOCAL_STACK_FRAME(_hx_pos_4a7af0c97c8b7a70_30_getTime,"Date","getTime",0x0cac7da3,"Date.getTime","/home/david/bin/haxe/std/cpp/_std/Date.hx",30,0xbabcdf82)
HX_LOCAL_STACK_FRAME(_hx_pos_4a7af0c97c8b7a70_94_toString,"Date","toString",0xd2a372cc,"Date.toString","/home/david/bin/haxe/std/cpp/_std/Date.hx",94,0xbabcdf82)
HX_LOCAL_STACK_FRAME(_hx_pos_4a7af0c97c8b7a70_105_fromTime,"Date","fromTime",0x44fd3cb7,"Date.fromTime","/home/david/bin/haxe/std/cpp/_std/Date.hx",105,0xbabcdf82)
HX_LOCAL_STACK_FRAME(_hx_pos_4a7af0c97c8b7a70_112_fromString,"Date","fromString",0x5ead97fb,"Date.fromString","/home/david/bin/haxe/std/cpp/_std/Date.hx",112,0xbabcdf82)

void Date_obj::__construct(int year,int month,int day,int hour,int min,int sec){
            	HX_STACKFRAME(&_hx_pos_4a7af0c97c8b7a70_26_new)
...
Float Date_obj::getTime(){
            	HX_STACKFRAME(&_hx_pos_4a7af0c97c8b7a70_30_getTime)
...
::String Date_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_4a7af0c97c8b7a70_94_toString)
...
HX_DEFINE_DYNAMIC_FUNC0(Date_obj,toString,return )
 ...
 ::Date Date_obj::fromTime(Float t){
            	HX_GC_STACKFRAME(&_hx_pos_4a7af0c97c8b7a70_105_fromTime)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Date_obj,fromTime,return )
 ...
 ::Date Date_obj::fromString(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_4a7af0c97c8b7a70_112_fromString)
