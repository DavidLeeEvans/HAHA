...
HX_LOCAL_STACK_FRAME(_hx_pos_187807b1acb8106b_33_getBytes,"sys.io.File","getBytes",0xbe457600,"sys.io.File.getBytes","/home/david/bin/haxe/std/cpp/_std/sys/io/File.hx",33,0xbbe3c029)
HX_LOCAL_STACK_FRAME(_hx_pos_187807b1acb8106b_44_saveBytes,"sys.io.File","saveBytes",0x6700fb83,"sys.io.File.saveBytes","/home/david/bin/haxe/std/cpp/_std/sys/io/File.hx",44,0xbbe3c029)
HX_LOCAL_STACK_FRAME(_hx_pos_187807b1acb8106b_51_read,"sys.io.File","read",0x203d07e1,"sys.io.File.read","/home/david/bin/haxe/std/cpp/_std/sys/io/File.hx",51,0xbbe3c029)
HX_LOCAL_STACK_FRAME(_hx_pos_187807b1acb8106b_55_write,"sys.io.File","write",0xfec8a9f4,"sys.io.File.write","/home/david/bin/haxe/std/cpp/_std/sys/io/File.hx",55,0xbbe3c029)
HX_LOCAL_STACK_FRAME(_hx_pos_187807b1acb8106b_69_copy,"sys.io.File","copy",0x165a7840,"sys.io.File.copy","/home/david/bin/haxe/std/cpp/_std/sys/io/File.hx",69,0xbbe3c029)
namespace sys{
namespace io{
...
bool File_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::io::Bytes File_obj::getBytes(::String path){
            	HX_STACKFRAME(&_hx_pos_187807b1acb8106b_33_getBytes)
...
void File_obj::saveBytes(::String path, ::haxe::io::Bytes bytes){
            	HX_STACKFRAME(&_hx_pos_187807b1acb8106b_44_saveBytes)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(File_obj,saveBytes,(void))
 ...
 ::sys::io::FileInput File_obj::read(::String path,::hx::Null< bool >  __o_binary){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_187807b1acb8106b_51_read)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(File_obj,read,return )
 ...
 ::sys::io::FileOutput File_obj::write(::String path,::hx::Null< bool >  __o_binary){
            		bool binary = __o_binary.Default(true);
            	HX_GC_STACKFRAME(&_hx_pos_187807b1acb8106b_55_write)
...
void File_obj::copy(::String srcPath,::String dstPath){
            	HX_STACKFRAME(&_hx_pos_187807b1acb8106b_69_copy)
