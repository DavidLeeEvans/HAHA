...
HX_DEFINE_STACK_FRAME(_hx_pos_b23185a5533dc1e2_33_new,"sys.io.FileOutput","new",0x19e22a16,"sys.io.FileOutput.new","/home/david/bin/haxe/std/cpp/_std/sys/io/FileOutput.hx",33,0xef2689e8)
HX_LOCAL_STACK_FRAME(_hx_pos_b23185a5533dc1e2_37_writeByte,"sys.io.FileOutput","writeByte",0x887099bd,"sys.io.FileOutput.writeByte","/home/david/bin/haxe/std/cpp/_std/sys/io/FileOutput.hx",37,0xef2689e8)
HX_LOCAL_STACK_FRAME(_hx_pos_b23185a5533dc1e2_44_writeBytes,"sys.io.FileOutput","writeBytes",0xda15ec16,"sys.io.FileOutput.writeBytes","/home/david/bin/haxe/std/cpp/_std/sys/io/FileOutput.hx",44,0xef2689e8)
HX_LOCAL_STACK_FRAME(_hx_pos_b23185a5533dc1e2_51_close,"sys.io.FileOutput","close",0xa583caee,"sys.io.FileOutput.close","/home/david/bin/haxe/std/cpp/_std/sys/io/FileOutput.hx",51,0xef2689e8)
namespace sys{
namespace io{

void FileOutput_obj::__construct( ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_b23185a5533dc1e2_33_new)
...
void FileOutput_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_b23185a5533dc1e2_37_writeByte)
HXDLIN(  37)		try {
...
int FileOutput_obj::writeBytes( ::haxe::io::Bytes s,int p,int l){
            	HX_STACKFRAME(&_hx_pos_b23185a5533dc1e2_44_writeBytes)
HXDLIN(  44)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
...
void FileOutput_obj::close(){
            	HX_STACKFRAME(&_hx_pos_b23185a5533dc1e2_51_close)
