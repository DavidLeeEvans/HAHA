...
HX_DEFINE_STACK_FRAME(_hx_pos_18b9f301955e79df_61_new,"sys.io._Process.Stdout","new",0xc765a8f4,"sys.io._Process.Stdout.new","/home/david/bin/haxe/std/cpp/_std/sys/io/Process.hx",61,0x2dbe33a8)
HX_LOCAL_STACK_FRAME(_hx_pos_18b9f301955e79df_67_readByte,"sys.io._Process.Stdout","readByte",0xa72b886a,"sys.io._Process.Stdout.readByte","/home/david/bin/haxe/std/cpp/_std/sys/io/Process.hx",67,0x2dbe33a8)
HX_LOCAL_STACK_FRAME(_hx_pos_18b9f301955e79df_73_readBytes,"sys.io._Process.Stdout","readBytes",0x9eebd4c9,"sys.io._Process.Stdout.readBytes","/home/david/bin/haxe/std/cpp/_std/sys/io/Process.hx",73,0x2dbe33a8)
namespace sys{
namespace io{
namespace _Process{

void Stdout_obj::__construct( ::Dynamic p,bool out){
            	HX_STACKFRAME(&_hx_pos_18b9f301955e79df_61_new)
HXLINE(  62)		this->p = p;
...
int Stdout_obj::readByte(){
            	HX_STACKFRAME(&_hx_pos_18b9f301955e79df_67_readByte)
...
int Stdout_obj::readBytes( ::haxe::io::Bytes str,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_18b9f301955e79df_73_readBytes)
