...
HX_DEFINE_STACK_FRAME(_hx_pos_983250be56b963c6_31_new,"sys.io._Process.Stdin","new",0xd3131563,"sys.io._Process.Stdin.new","/home/david/bin/haxe/std/cpp/_std/sys/io/Process.hx",31,0x2dbe33a8)
HX_LOCAL_STACK_FRAME(_hx_pos_983250be56b963c6_36_close,"sys.io._Process.Stdin","close",0xbd3fe37b,"sys.io._Process.Stdin.close","/home/david/bin/haxe/std/cpp/_std/sys/io/Process.hx",36,0x2dbe33a8)
HX_LOCAL_STACK_FRAME(_hx_pos_983250be56b963c6_41_writeByte,"sys.io._Process.Stdin","writeByte",0xfb987cca,"sys.io._Process.Stdin.writeByte","/home/david/bin/haxe/std/cpp/_std/sys/io/Process.hx",41,0x2dbe33a8)
HX_LOCAL_STACK_FRAME(_hx_pos_983250be56b963c6_47_writeBytes,"sys.io._Process.Stdin","writeBytes",0x29d4b469,"sys.io._Process.Stdin.writeBytes","/home/david/bin/haxe/std/cpp/_std/sys/io/Process.hx",47,0x2dbe33a8)
namespace sys{
namespace io{
namespace _Process{

void Stdin_obj::__construct( ::Dynamic p){
            	HX_STACKFRAME(&_hx_pos_983250be56b963c6_31_new)
HXLINE(  32)		this->p = p;
...
void Stdin_obj::close(){
            	HX_STACKFRAME(&_hx_pos_983250be56b963c6_36_close)
...
void Stdin_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_983250be56b963c6_41_writeByte)
...
int Stdin_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_983250be56b963c6_47_writeBytes)
HXDLIN(  47)		try {
