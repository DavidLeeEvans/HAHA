...
HX_LOCAL_STACK_FRAME(_hx_pos_0f2e0320197519b6_31_exists,"sys.FileSystem","exists",0xf55bed9e,"sys.FileSystem.exists","/home/david/bin/haxe/std/cpp/_std/sys/FileSystem.hx",31,0xcae70a03)
HX_LOCAL_STACK_FRAME(_hx_pos_0f2e0320197519b6_38_stat,"sys.FileSystem","stat",0xa630df16,"sys.FileSystem.stat","/home/david/bin/haxe/std/cpp/_std/sys/FileSystem.hx",38,0xcae70a03)
HX_LOCAL_STACK_FRAME(_hx_pos_0f2e0320197519b6_75_isDirectory,"sys.FileSystem","isDirectory",0x6c577a21,"sys.FileSystem.isDirectory","/home/david/bin/haxe/std/cpp/_std/sys/FileSystem.hx",75,0xcae70a03)
HX_LOCAL_STACK_FRAME(_hx_pos_0f2e0320197519b6_78_createDirectory,"sys.FileSystem","createDirectory",0x63bad3cf,"sys.FileSystem.createDirectory","/home/david/bin/haxe/std/cpp/_std/sys/FileSystem.hx",78,0xcae70a03)
HX_LOCAL_STACK_FRAME(_hx_pos_0f2e0320197519b6_93_deleteFile,"sys.FileSystem","deleteFile",0x4bd48509,"sys.FileSystem.deleteFile","/home/david/bin/haxe/std/cpp/_std/sys/FileSystem.hx",93,0xcae70a03)
HX_LOCAL_STACK_FRAME(_hx_pos_0f2e0320197519b6_97_deleteDirectory,"sys.FileSystem","deleteDirectory",0x052a5cc0,"sys.FileSystem.deleteDirectory","/home/david/bin/haxe/std/cpp/_std/sys/FileSystem.hx",97,0xcae70a03)
HX_LOCAL_STACK_FRAME(_hx_pos_0f2e0320197519b6_101_readDirectory,"sys.FileSystem","readDirectory",0x0619f8b5,"sys.FileSystem.readDirectory","/home/david/bin/haxe/std/cpp/_std/sys/FileSystem.hx",101,0xcae70a03)
namespace sys{
...
bool FileSystem_obj::exists(::String path){
            	HX_STACKFRAME(&_hx_pos_0f2e0320197519b6_31_exists)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(FileSystem_obj,exists,return )
 ...
 ::Dynamic FileSystem_obj::stat(::String path){
            	HX_STACKFRAME(&_hx_pos_0f2e0320197519b6_38_stat)
HXLINE(  39)		::String s;
HXDLIN(  39)		bool s1;
...
bool FileSystem_obj::isDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_0f2e0320197519b6_75_isDirectory)
...
void FileSystem_obj::createDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_0f2e0320197519b6_78_createDirectory)
...
void FileSystem_obj::deleteFile(::String path){
            	HX_STACKFRAME(&_hx_pos_0f2e0320197519b6_93_deleteFile)
...
void FileSystem_obj::deleteDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_0f2e0320197519b6_97_deleteDirectory)
...
::Array< ::String > FileSystem_obj::readDirectory(::String path){
            	HX_STACKFRAME(&_hx_pos_0f2e0320197519b6_101_readDirectory)
