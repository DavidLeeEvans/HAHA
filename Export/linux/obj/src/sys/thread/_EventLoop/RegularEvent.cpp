...
HX_DEFINE_STACK_FRAME(_hx_pos_0cd65ac2fdc9773b_262_new,"sys.thread._EventLoop.RegularEvent","new",0x9d3b475c,"sys.thread._EventLoop.RegularEvent.new","/home/david/bin/haxe/std/sys/thread/EventLoop.hx",262,0x4821a132)
namespace sys{
namespace thread{
namespace _EventLoop{

void RegularEvent_obj::__construct( ::Dynamic run,Float nextRunTime,Float interval){
            	HX_STACKFRAME(&_hx_pos_0cd65ac2fdc9773b_262_new)
