...
HX_DEFINE_STACK_FRAME(_hx_pos_5e8f81fc96218cee_24_new,"sys.thread.EventLoop","new",0xafe12fcd,"sys.thread.EventLoop.new","/home/david/bin/haxe/std/sys/thread/EventLoop.hx",24,0x4821a132)
HX_LOCAL_STACK_FRAME(_hx_pos_5e8f81fc96218cee_140_progress,"sys.thread.EventLoop","progress",0xd3ab8d20,"sys.thread.EventLoop.progress","/home/david/bin/haxe/std/sys/thread/EventLoop.hx",140,0x4821a132)
HX_LOCAL_STACK_FRAME(_hx_pos_5e8f81fc96218cee_173_loop,"sys.thread.EventLoop","loop",0x33ddc657,"sys.thread.EventLoop.loop","/home/david/bin/haxe/std/sys/thread/EventLoop.hx",173,0x4821a132)
namespace sys{
namespace thread{

void EventLoop_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_5e8f81fc96218cee_24_new)
...
bool EventLoop_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::sys::thread::NextEventTime EventLoop_obj::progress(){
            	HX_STACKFRAME(&_hx_pos_5e8f81fc96218cee_140_progress)
...
void EventLoop_obj::loop(){
            	HX_STACKFRAME(&_hx_pos_5e8f81fc96218cee_173_loop)
