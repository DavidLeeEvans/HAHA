...
HX_DEFINE_STACK_FRAME(_hx_pos_36e0ebe56c9c2cb9_7_new,"sys.thread.NoEventLoopException","new",0x6e47ae47,"sys.thread.NoEventLoopException.new","/home/david/bin/haxe/std/sys/thread/NoEventLoopException.hx",7,0x26ac367a)
namespace sys{
namespace thread{
...
void NoEventLoopException_obj::__construct(::String __o_msg, ::haxe::Exception previous){
            	...
            	HX_STACKFRAME(&_hx_pos_36e0ebe56c9c2cb9_7_new)
