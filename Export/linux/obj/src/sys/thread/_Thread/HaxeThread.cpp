...
HX_DEFINE_STACK_FRAME(_hx_pos_9f335e6e72cccbbd_171_new,"sys.thread._Thread.HaxeThread","new",0x28e1daea,"sys.thread._Thread.HaxeThread.new","/home/david/bin/haxe/std/cpp/_std/sys/thread/Thread.hx",171,0x1bd73c3f)
HX_LOCAL_STACK_FRAME(_hx_pos_7985dd7efec18b3c_79___init__,"::sys::thread::_Thread::HaxeThread_obj","__init__",0x85b0f2c4,"::sys::thread::_Thread::HaxeThread_obj.__init__","/home/david/bin/haxe/std/cpp/_std/sys/thread/Thread.hx",79,0x1bd73c3f)
HX_LOCAL_STACK_FRAME(_hx_pos_9f335e6e72cccbbd_91_current,"sys.thread._Thread.HaxeThread","current",0xca8ab3c3,"sys.thread._Thread.HaxeThread.current","/home/david/bin/haxe/std/cpp/_std/sys/thread/Thread.hx",91,0x1bd73c3f)
HX_LOCAL_STACK_FRAME(_hx_pos_9f335e6e72cccbbd_119_create,"sys.thread._Thread.HaxeThread","create",0x979b0eb2,"sys.thread._Thread.HaxeThread.create","/home/david/bin/haxe/std/cpp/_std/sys/thread/Thread.hx",119,0x1bd73c3f)
HX_LOCAL_STACK_FRAME(_hx_pos_9f335e6e72cccbbd_112_create,"sys.thread._Thread.HaxeThread","create",0x979b0eb2,"sys.thread._Thread.HaxeThread.create","/home/david/bin/haxe/std/cpp/_std/sys/thread/Thread.hx",112,0x1bd73c3f)
HX_LOCAL_STACK_FRAME(_hx_pos_9f335e6e72cccbbd_155_dropThread,"sys.thread._Thread.HaxeThread","dropThread",0xc101af0f,"sys.thread._Thread.HaxeThread.dropThread","/home/david/bin/haxe/std/cpp/_std/sys/thread/Thread.hx",155,0x1bd73c3f)
namespace sys{
namespace thread{
namespace _Thread{

void HaxeThread_obj::__construct( ::Dynamic h){
            	HX_STACKFRAME(&_hx_pos_9f335e6e72cccbbd_171_new)
...
void HaxeThread_obj::__init__(){
            	HX_GC_STACKFRAME(&_hx_pos_7985dd7efec18b3c_79___init__)
...
::Array< ::Dynamic> HaxeThread_obj::threads;
 ...
 ::sys::thread::_Thread::HaxeThread HaxeThread_obj::current(){
            	HX_GC_STACKFRAME(&_hx_pos_9f335e6e72cccbbd_91_current)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC0(HaxeThread_obj,current,return )
 ...
 ::sys::thread::_Thread::HaxeThread HaxeThread_obj::create( ::Dynamic job,bool withEventLoop){
            		...
            		void _hx_run(){
            			HX_GC_STACKFRAME(&_hx_pos_9f335e6e72cccbbd_119_create)
...
HXLINE( 132)			::sys::thread::_Thread::HaxeThread_obj::dropThread(item,index);
            	...
            	HX_GC_STACKFRAME(&_hx_pos_9f335e6e72cccbbd_112_create)
...
void HaxeThread_obj::dropThread( ::Dynamic item,int probableIndex){
            	HX_STACKFRAME(&_hx_pos_9f335e6e72cccbbd_155_dropThread)
