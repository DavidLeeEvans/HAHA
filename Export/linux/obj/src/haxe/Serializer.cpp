...
HX_DEFINE_STACK_FRAME(_hx_pos_24a48b0031507687_103_new,"haxe.Serializer","new",0xcdbbc7ec,"haxe.Serializer.new","/home/david/bin/haxe/std/haxe/Serializer.hx",103,0x13db67f4)
HX_LOCAL_STACK_FRAME(_hx_pos_24a48b0031507687_119_toString,"haxe.Serializer","toString",0x95bdfda0,"haxe.Serializer.toString","/home/david/bin/haxe/std/haxe/Serializer.hx",119,0x13db67f4)
HX_LOCAL_STACK_FRAME(_hx_pos_24a48b0031507687_154_serializeString,"haxe.Serializer","serializeString",0xd565bc5d,"haxe.Serializer.serializeString","/home/david/bin/haxe/std/haxe/Serializer.hx",154,0x13db67f4)
...
HX_LOCAL_STACK_FRAME(_hx_pos_24a48b0031507687_174_serializeRef,"haxe.Serializer","serializeRef",0x0b8ed647,"haxe.Serializer.serializeRef","/home/david/bin/haxe/std/haxe/Serializer.hx",174,0x13db67f4)
static const ::String _hx_array_data_6a6ea1fa_8[] = {
	HX_("r",72,00,00,00),
};
HX_LOCAL_STACK_FRAME(_hx_pos_24a48b0031507687_211_serializeFields,"haxe.Serializer","serializeFields",0x44c42205,"haxe.Serializer.serializeFields","/home/david/bin/haxe/std/haxe/Serializer.hx",211,0x13db67f4)
static const ::String _hx_array_data_6a6ea1fa_11[] = {
	HX_("g",67,00,00,00),
};
HX_LOCAL_STACK_FRAME(_hx_pos_24a48b0031507687_230_serialize,"haxe.Serializer","serialize",0x3cea866c,"haxe.Serializer.serialize","/home/david/bin/haxe/std/haxe/Serializer.hx",230,0x13db67f4)
...
HX_LOCAL_STACK_FRAME(_hx_pos_24a48b0031507687_582_run,"haxe.Serializer","run",0xcdbeded7,"haxe.Serializer.run","/home/david/bin/haxe/std/haxe/Serializer.hx",582,0x13db67f4)
HX_LOCAL_STACK_FRAME(_hx_pos_24a48b0031507687_57_boot,"haxe.Serializer","boot",0x2eac2726,"haxe.Serializer.boot","/home/david/bin/haxe/std/haxe/Serializer.hx",57,0x13db67f4)
HX_LOCAL_STACK_FRAME(_hx_pos_24a48b0031507687_69_boot,"haxe.Serializer","boot",0x2eac2726,"haxe.Serializer.boot","/home/david/bin/haxe/std/haxe/Serializer.hx",69,0x13db67f4)
HX_LOCAL_STACK_FRAME(_hx_pos_24a48b0031507687_71_boot,"haxe.Serializer","boot",0x2eac2726,"haxe.Serializer.boot","/home/david/bin/haxe/std/haxe/Serializer.hx",71,0x13db67f4)
HX_LOCAL_STACK_FRAME(_hx_pos_24a48b0031507687_72_boot,"haxe.Serializer","boot",0x2eac2726,"haxe.Serializer.boot","/home/david/bin/haxe/std/haxe/Serializer.hx",72,0x13db67f4)
namespace haxe{

void Serializer_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_24a48b0031507687_103_new)
...
::String Serializer_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_24a48b0031507687_119_toString)
...
void Serializer_obj::serializeString(::String s){
            	HX_STACKFRAME(&_hx_pos_24a48b0031507687_154_serializeString)
...
bool Serializer_obj::serializeRef( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_24a48b0031507687_174_serializeRef)
HXLINE( 178)		{
HXLINE( 178)			int _g = 0;
...
void Serializer_obj::serializeFields( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_24a48b0031507687_211_serializeFields)
HXLINE( 212)		{
HXLINE( 212)			int _g = 0;
...
void Serializer_obj::serialize( ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_24a48b0031507687_230_serialize)
...
::String Serializer_obj::run( ::Dynamic v){
            	HX_GC_STACKFRAME(&_hx_pos_24a48b0031507687_582_run)
...
{
{
            	HX_STACKFRAME(&_hx_pos_24a48b0031507687_57_boot)
HXDLIN(  57)		USE_CACHE = false;
            	}
{
            	HX_STACKFRAME(&_hx_pos_24a48b0031507687_69_boot)
HXDLIN(  69)		USE_ENUM_INDEX = false;
            	}
{
            	HX_STACKFRAME(&_hx_pos_24a48b0031507687_71_boot)
HXDLIN(  71)		BASE64 = HX_("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789%:",d4,3b,03,7f);
            	}
{
            	HX_STACKFRAME(&_hx_pos_24a48b0031507687_72_boot)
