...
HX_DEFINE_STACK_FRAME(_hx_pos_5ce4c41b1fbac8a4_281_new,"haxe.ds._List.ListIterator","new",0x2a47d966,"haxe.ds._List.ListIterator.new","/home/david/bin/haxe/std/haxe/ds/List.hx",281,0xd44c2198)
HX_LOCAL_STACK_FRAME(_hx_pos_5ce4c41b1fbac8a4_285_hasNext,"haxe.ds._List.ListIterator","hasNext",0x5bdaa973,"haxe.ds._List.ListIterator.hasNext","/home/david/bin/haxe/std/haxe/ds/List.hx",285,0xd44c2198)
HX_LOCAL_STACK_FRAME(_hx_pos_5ce4c41b1fbac8a4_288_next,"haxe.ds._List.ListIterator","next",0xd496612d,"haxe.ds._List.ListIterator.next","/home/david/bin/haxe/std/haxe/ds/List.hx",288,0xd44c2198)
namespace haxe{
namespace ds{
namespace _List{

void ListIterator_obj::__construct( ::haxe::ds::_List::ListNode head){
            	HX_STACKFRAME(&_hx_pos_5ce4c41b1fbac8a4_281_new)
...
bool ListIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_5ce4c41b1fbac8a4_285_hasNext)
...
HX_DEFINE_DYNAMIC_FUNC0(ListIterator_obj,hasNext,return )
 ...
 ::Dynamic ListIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_5ce4c41b1fbac8a4_288_next)
