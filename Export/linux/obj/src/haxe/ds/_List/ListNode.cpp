...
HX_DEFINE_STACK_FRAME(_hx_pos_0e14d6f33fe4a1af_266_new,"haxe.ds._List.ListNode","new",0x5847787a,"haxe.ds._List.ListNode.new","/home/david/bin/haxe/std/haxe/ds/List.hx",266,0xd44c2198)
namespace haxe{
namespace ds{
namespace _List{

void ListNode_obj::__construct( ::Dynamic item, ::haxe::ds::_List::ListNode next){
            	HX_STACKFRAME(&_hx_pos_0e14d6f33fe4a1af_266_new)
