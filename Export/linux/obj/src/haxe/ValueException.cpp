...
HX_DEFINE_STACK_FRAME(_hx_pos_0e7b8899dea82329_23_new,"haxe.ValueException","new",0xb19045f8,"haxe.ValueException.new","/home/david/bin/haxe/std/haxe/ValueException.hx",23,0x3577a768)
HX_LOCAL_STACK_FRAME(_hx_pos_0e7b8899dea82329_36_unwrap,"haxe.ValueException","unwrap",0xe3875a0b,"haxe.ValueException.unwrap","/home/david/bin/haxe/std/haxe/ValueException.hx",36,0x3577a768)
namespace haxe{

void ValueException_obj::__construct( ::Dynamic value, ::haxe::Exception previous, ::Dynamic native){
            	HX_STACKFRAME(&_hx_pos_0e7b8899dea82329_23_new)
...
bool ValueException_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic ValueException_obj::unwrap(){
            	HX_STACKFRAME(&_hx_pos_0e7b8899dea82329_36_unwrap)
