...
HX_DEFINE_STACK_FRAME(_hx_pos_51916fb3b94b97d1_32_new,"haxe.zip.HuffTools","new",0x5263948b,"haxe.zip.HuffTools.new","/home/david/bin/haxe/std/haxe/zip/Huffman.hx",32,0xa0c50bd7)
HX_LOCAL_STACK_FRAME(_hx_pos_51916fb3b94b97d1_35_treeDepth,"haxe.zip.HuffTools","treeDepth",0x748ac930,"haxe.zip.HuffTools.treeDepth","/home/david/bin/haxe/std/haxe/zip/Huffman.hx",35,0xa0c50bd7)
HX_LOCAL_STACK_FRAME(_hx_pos_51916fb3b94b97d1_45_treeCompress,"haxe.zip.HuffTools","treeCompress",0x66340995,"haxe.zip.HuffTools.treeCompress","/home/david/bin/haxe/std/haxe/zip/Huffman.hx",45,0xa0c50bd7)
HX_LOCAL_STACK_FRAME(_hx_pos_51916fb3b94b97d1_63_treeWalk,"haxe.zip.HuffTools","treeWalk",0x2e5c697c,"haxe.zip.HuffTools.treeWalk","/home/david/bin/haxe/std/haxe/zip/Huffman.hx",63,0xa0c50bd7)
HX_LOCAL_STACK_FRAME(_hx_pos_51916fb3b94b97d1_75_treeMake,"haxe.zip.HuffTools","treeMake",0x27c04661,"haxe.zip.HuffTools.treeMake","/home/david/bin/haxe/std/haxe/zip/Huffman.hx",75,0xa0c50bd7)
HX_LOCAL_STACK_FRAME(_hx_pos_51916fb3b94b97d1_86_make,"haxe.zip.HuffTools","make",0xc4121b63,"haxe.zip.HuffTools.make","/home/david/bin/haxe/std/haxe/zip/Huffman.hx",86,0xa0c50bd7)
namespace haxe{
namespace zip{

void HuffTools_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_51916fb3b94b97d1_32_new)
            	}
...
int HuffTools_obj::treeDepth( ::haxe::zip::Huffman t){
            	HX_STACKFRAME(&_hx_pos_51916fb3b94b97d1_35_treeDepth)
...
HX_DEFINE_DYNAMIC_FUNC1(HuffTools_obj,treeDepth,return )
 ...
 ::haxe::zip::Huffman HuffTools_obj::treeCompress( ::haxe::zip::Huffman t){
            	HX_STACKFRAME(&_hx_pos_51916fb3b94b97d1_45_treeCompress)
...
void HuffTools_obj::treeWalk(::Array< ::Dynamic> table,int p,int cd,int d, ::haxe::zip::Huffman t){
            	HX_STACKFRAME(&_hx_pos_51916fb3b94b97d1_63_treeWalk)
...
HX_DEFINE_DYNAMIC_FUNC5(HuffTools_obj,treeWalk,(void))
 ...
 ::haxe::zip::Huffman HuffTools_obj::treeMake( ::haxe::ds::IntMap bits,int maxbits,int v,int len){
            	HX_STACKFRAME(&_hx_pos_51916fb3b94b97d1_75_treeMake)
...
HX_DEFINE_DYNAMIC_FUNC4(HuffTools_obj,treeMake,return )
 ...
 ::haxe::zip::Huffman HuffTools_obj::make(::Array< int > lengths,int pos,int nlengths,int maxbits){
            	HX_GC_STACKFRAME(&_hx_pos_51916fb3b94b97d1_86_make)
