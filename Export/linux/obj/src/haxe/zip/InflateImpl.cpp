...
HX_DEFINE_STACK_FRAME(_hx_pos_a0746d9bd90ef908_129_new,"haxe.zip.InflateImpl","new",0x8adfb384,"haxe.zip.InflateImpl.new","/home/david/bin/haxe/std/haxe/zip/InflateImpl.hx",129,0xaaf2d33d)
HX_LOCAL_STACK_FRAME(_hx_pos_a0746d9bd90ef908_149_buildFixedHuffman,"haxe.zip.InflateImpl","buildFixedHuffman",0x8189428b,"haxe.zip.InflateImpl.buildFixedHuffman","/home/david/bin/haxe/std/haxe/zip/InflateImpl.hx",149,0xaaf2d33d)
HX_LOCAL_STACK_FRAME(_hx_pos_a0746d9bd90ef908_159_readBytes,"haxe.zip.InflateImpl","readBytes",0x749c2b59,"haxe.zip.InflateImpl.readBytes","/home/david/bin/haxe/std/haxe/zip/InflateImpl.hx",159,0xaaf2d33d)
HX_LOCAL_STACK_FRAME(_hx_pos_a0746d9bd90ef908_168_getBits,"haxe.zip.InflateImpl","getBits",0xefbfefe0,"haxe.zip.InflateImpl.getBits","/home/david/bin/haxe/std/haxe/zip/InflateImpl.hx",168,0xaaf2d33d)
HX_LOCAL_STACK_FRAME(_hx_pos_a0746d9bd90ef908_179_getBit,"haxe.zip.InflateImpl","getBit",0x24a99d33,"haxe.zip.InflateImpl.getBit","/home/david/bin/haxe/std/haxe/zip/InflateImpl.hx",179,0xaaf2d33d)
HX_LOCAL_STACK_FRAME(_hx_pos_a0746d9bd90ef908_191_getRevBits,"haxe.zip.InflateImpl","getRevBits",0xc652fd6f,"haxe.zip.InflateImpl.getRevBits","/home/david/bin/haxe/std/haxe/zip/InflateImpl.hx",191,0xaaf2d33d)
HX_LOCAL_STACK_FRAME(_hx_pos_a0746d9bd90ef908_199_resetBits,"haxe.zip.InflateImpl","resetBits",0x6d1fda99,"haxe.zip.InflateImpl.resetBits","/home/david/bin/haxe/std/haxe/zip/InflateImpl.hx",199,0xaaf2d33d)
HX_LOCAL_STACK_FRAME(_hx_pos_a0746d9bd90ef908_204_addBytes,"haxe.zip.InflateImpl","addBytes",0xfc4b68e6,"haxe.zip.InflateImpl.addBytes","/home/david/bin/haxe/std/haxe/zip/InflateImpl.hx",204,0xaaf2d33d)
HX_LOCAL_STACK_FRAME(_hx_pos_a0746d9bd90ef908_211_addByte,"haxe.zip.InflateImpl","addByte",0x5986a6ed,"haxe.zip.InflateImpl.addByte","/home/david/bin/haxe/std/haxe/zip/InflateImpl.hx",211,0xaaf2d33d)
HX_LOCAL_STACK_FRAME(_hx_pos_a0746d9bd90ef908_218_addDistOne,"haxe.zip.InflateImpl","addDistOne",0x9881c3db,"haxe.zip.InflateImpl.addDistOne","/home/david/bin/haxe/std/haxe/zip/InflateImpl.hx",218,0xaaf2d33d)
HX_LOCAL_STACK_FRAME(_hx_pos_a0746d9bd90ef908_225_addDist,"haxe.zip.InflateImpl","addDist",0x5accef4b,"haxe.zip.InflateImpl.addDist","/home/david/bin/haxe/std/haxe/zip/InflateImpl.hx",225,0xaaf2d33d)
HX_LOCAL_STACK_FRAME(_hx_pos_a0746d9bd90ef908_229_applyHuffman,"haxe.zip.InflateImpl","applyHuffman",0x495d53bb,"haxe.zip.InflateImpl.applyHuffman","/home/david/bin/haxe/std/haxe/zip/InflateImpl.hx",229,0xaaf2d33d)
HX_LOCAL_STACK_FRAME(_hx_pos_a0746d9bd90ef908_236_inflateLengths,"haxe.zip.InflateImpl","inflateLengths",0xf1ca5662,"haxe.zip.InflateImpl.inflateLengths","/home/david/bin/haxe/std/haxe/zip/InflateImpl.hx",236,0xaaf2d33d)
HX_LOCAL_STACK_FRAME(_hx_pos_a0746d9bd90ef908_269_inflateLoop,"haxe.zip.InflateImpl","inflateLoop",0x6d5c65af,"haxe.zip.InflateImpl.inflateLoop","/home/david/bin/haxe/std/haxe/zip/InflateImpl.hx",269,0xaaf2d33d)
HX_LOCAL_STACK_FRAME(_hx_pos_a0746d9bd90ef908_97_boot,"haxe.zip.InflateImpl","boot",0xf0f6608e,"haxe.zip.InflateImpl.boot","/home/david/bin/haxe/std/haxe/zip/InflateImpl.hx",97,0xaaf2d33d)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a0746d9bd90ef908_100_boot,"haxe.zip.InflateImpl","boot",0xf0f6608e,"haxe.zip.InflateImpl.boot","/home/david/bin/haxe/std/haxe/zip/InflateImpl.hx",100,0xaaf2d33d)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a0746d9bd90ef908_103_boot,"haxe.zip.InflateImpl","boot",0xf0f6608e,"haxe.zip.InflateImpl.boot","/home/david/bin/haxe/std/haxe/zip/InflateImpl.hx",103,0xaaf2d33d)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a0746d9bd90ef908_106_boot,"haxe.zip.InflateImpl","boot",0xf0f6608e,"haxe.zip.InflateImpl.boot","/home/david/bin/haxe/std/haxe/zip/InflateImpl.hx",106,0xaaf2d33d)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a0746d9bd90ef908_109_boot,"haxe.zip.InflateImpl","boot",0xf0f6608e,"haxe.zip.InflateImpl.boot","/home/david/bin/haxe/std/haxe/zip/InflateImpl.hx",109,0xaaf2d33d)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a0746d9bd90ef908_127_boot,"haxe.zip.InflateImpl","boot",0xf0f6608e,"haxe.zip.InflateImpl.boot","/home/david/bin/haxe/std/haxe/zip/InflateImpl.hx",127,0xaaf2d33d)
namespace haxe{
namespace zip{
...
void InflateImpl_obj::__construct( ::haxe::io::Input i, ::Dynamic __o_header, ::Dynamic __o_crc){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_a0746d9bd90ef908_129_new)
...
bool InflateImpl_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::zip::Huffman InflateImpl_obj::buildFixedHuffman(){
            	HX_STACKFRAME(&_hx_pos_a0746d9bd90ef908_149_buildFixedHuffman)
...
int InflateImpl_obj::readBytes( ::haxe::io::Bytes b,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_a0746d9bd90ef908_159_readBytes)
...
int InflateImpl_obj::getBits(int n){
            	HX_STACKFRAME(&_hx_pos_a0746d9bd90ef908_168_getBits)
...
bool InflateImpl_obj::getBit(){
            	HX_STACKFRAME(&_hx_pos_a0746d9bd90ef908_179_getBit)
...
int InflateImpl_obj::getRevBits(int n){
            	HX_STACKFRAME(&_hx_pos_a0746d9bd90ef908_191_getRevBits)
HXDLIN( 191)		if ((n == 0)) {
HXLINE( 192)			return 0;
            		}
            		else {
...
void InflateImpl_obj::resetBits(){
            	HX_STACKFRAME(&_hx_pos_a0746d9bd90ef908_199_resetBits)
...
void InflateImpl_obj::addBytes( ::haxe::io::Bytes b,int p,int len){
            	HX_STACKFRAME(&_hx_pos_a0746d9bd90ef908_204_addBytes)
...
void InflateImpl_obj::addByte(int b){
            	HX_STACKFRAME(&_hx_pos_a0746d9bd90ef908_211_addByte)
...
void InflateImpl_obj::addDistOne(int n){
            	HX_STACKFRAME(&_hx_pos_a0746d9bd90ef908_218_addDistOne)
...
void InflateImpl_obj::addDist(int d,int len){
            	HX_STACKFRAME(&_hx_pos_a0746d9bd90ef908_225_addDist)
...
int InflateImpl_obj::applyHuffman( ::haxe::zip::Huffman h){
            	HX_STACKFRAME(&_hx_pos_a0746d9bd90ef908_229_applyHuffman)
...
void InflateImpl_obj::inflateLengths(::Array< int > a,int max){
            	HX_STACKFRAME(&_hx_pos_a0746d9bd90ef908_236_inflateLengths)
HXLINE( 237)		int i = 0;
...
bool InflateImpl_obj::inflateLoop(){
            	HX_STACKFRAME(&_hx_pos_a0746d9bd90ef908_269_inflateLoop)
