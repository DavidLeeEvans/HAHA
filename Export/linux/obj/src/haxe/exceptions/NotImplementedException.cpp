...
HX_DEFINE_STACK_FRAME(_hx_pos_b12b5e29f77ee7b8_8_new,"haxe.exceptions.NotImplementedException","new",0xcfd1d5d0,"haxe.exceptions.NotImplementedException.new","/home/david/bin/haxe/std/haxe/exceptions/NotImplementedException.hx",8,0x3126afd1)
namespace haxe{
...
void NotImplementedException_obj::__construct(::String __o_message, ::haxe::Exception previous, ::Dynamic pos){
            	...
            	HX_STACKFRAME(&_hx_pos_b12b5e29f77ee7b8_8_new)
