...
HX_DEFINE_STACK_FRAME(_hx_pos_71c1ee7b0f35b998_12_new,"haxe.exceptions.PosException","new",0x9ed038cf,"haxe.exceptions.PosException.new","/home/david/bin/haxe/std/haxe/exceptions/PosException.hx",12,0x59dfd9b0)
HX_LOCAL_STACK_FRAME(_hx_pos_71c1ee7b0f35b998_25_toString,"haxe.exceptions.PosException","toString",0x179675dd,"haxe.exceptions.PosException.toString","/home/david/bin/haxe/std/haxe/exceptions/PosException.hx",25,0x59dfd9b0)
namespace haxe{
namespace exceptions{

void PosException_obj::__construct(::String message, ::haxe::Exception previous, ::Dynamic pos){
            	HX_STACKFRAME(&_hx_pos_71c1ee7b0f35b998_12_new)
...
::String PosException_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_71c1ee7b0f35b998_25_toString)
