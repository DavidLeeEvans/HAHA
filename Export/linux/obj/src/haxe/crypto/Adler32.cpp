...
HX_DEFINE_STACK_FRAME(_hx_pos_5acf3a001583f9a7_32_new,"haxe.crypto.Adler32","new",0xc900c8e2,"haxe.crypto.Adler32.new","/home/david/bin/haxe/std/haxe/crypto/Adler32.hx",32,0x2dd4daff)
HX_LOCAL_STACK_FRAME(_hx_pos_5acf3a001583f9a7_41_update,"haxe.crypto.Adler32","update",0xb4b14ac7,"haxe.crypto.Adler32.update","/home/david/bin/haxe/std/haxe/crypto/Adler32.hx",41,0x2dd4daff)
HX_LOCAL_STACK_FRAME(_hx_pos_5acf3a001583f9a7_53_equals,"haxe.crypto.Adler32","equals",0xed9eb2fd,"haxe.crypto.Adler32.equals","/home/david/bin/haxe/std/haxe/crypto/Adler32.hx",53,0x2dd4daff)
HX_LOCAL_STACK_FRAME(_hx_pos_5acf3a001583f9a7_60_read,"haxe.crypto.Adler32","read",0x1a53c494,"haxe.crypto.Adler32.read","/home/david/bin/haxe/std/haxe/crypto/Adler32.hx",60,0x2dd4daff)
namespace haxe{
namespace crypto{

void Adler32_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_5acf3a001583f9a7_32_new)
HXLINE(  33)		this->a1 = 1;
HXLINE(  34)		this->a2 = 0;
            	}
...
void Adler32_obj::update( ::haxe::io::Bytes b,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_5acf3a001583f9a7_41_update)
...
bool Adler32_obj::equals( ::haxe::crypto::Adler32 a){
            	HX_STACKFRAME(&_hx_pos_5acf3a001583f9a7_53_equals)
...
HX_DEFINE_DYNAMIC_FUNC1(Adler32_obj,equals,return )
 ...
 ::haxe::crypto::Adler32 Adler32_obj::read( ::haxe::io::Input i){
            	HX_GC_STACKFRAME(&_hx_pos_5acf3a001583f9a7_60_read)
