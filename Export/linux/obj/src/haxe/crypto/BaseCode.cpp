...
HX_DEFINE_STACK_FRAME(_hx_pos_da655fff6357eaaa_33_new,"haxe.crypto.BaseCode","new",0xd63c60f5,"haxe.crypto.BaseCode.new","/home/david/bin/haxe/std/haxe/crypto/BaseCode.hx",33,0x3a342cca)
HX_LOCAL_STACK_FRAME(_hx_pos_da655fff6357eaaa_72_initTable,"haxe.crypto.BaseCode","initTable",0xa1288133,"haxe.crypto.BaseCode.initTable","/home/david/bin/haxe/std/haxe/crypto/BaseCode.hx",72,0x3a342cca)
HX_LOCAL_STACK_FRAME(_hx_pos_da655fff6357eaaa_81_decodeBytes,"haxe.crypto.BaseCode","decodeBytes",0x152c41f2,"haxe.crypto.BaseCode.decodeBytes","/home/david/bin/haxe/std/haxe/crypto/BaseCode.hx",81,0x3a342cca)
namespace haxe{
namespace crypto{

void BaseCode_obj::__construct( ::haxe::io::Bytes base){
            	HX_STACKFRAME(&_hx_pos_da655fff6357eaaa_33_new)
...
void BaseCode_obj::initTable(){
            	HX_STACKFRAME(&_hx_pos_da655fff6357eaaa_72_initTable)
...
HX_DEFINE_DYNAMIC_FUNC0(BaseCode_obj,initTable,(void))
 ...
 ::haxe::io::Bytes BaseCode_obj::decodeBytes( ::haxe::io::Bytes b){
            	HX_STACKFRAME(&_hx_pos_da655fff6357eaaa_81_decodeBytes)
