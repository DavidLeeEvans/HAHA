...
HX_LOCAL_STACK_FRAME(_hx_pos_fc1982f3765a523e_26_is,"Std","is",0x3c56d6f5,"Std.is","/home/david/bin/haxe/std/cpp/_std/Std.hx",26,0x66a3cc09)
HX_LOCAL_STACK_FRAME(_hx_pos_fc1982f3765a523e_30_isOfType,"Std","isOfType",0x6718c846,"Std.isOfType","/home/david/bin/haxe/std/cpp/_std/Std.hx",30,0x66a3cc09)
HX_LOCAL_STACK_FRAME(_hx_pos_fc1982f3765a523e_34_downcast,"Std","downcast",0x4619c56c,"Std.downcast","/home/david/bin/haxe/std/cpp/_std/Std.hx",34,0x66a3cc09)
HX_LOCAL_STACK_FRAME(_hx_pos_fc1982f3765a523e_39_instance,"Std","instance",0x1431f4e0,"Std.instance","/home/david/bin/haxe/std/cpp/_std/Std.hx",39,0x66a3cc09)
HX_LOCAL_STACK_FRAME(_hx_pos_fc1982f3765a523e_43_string,"Std","string",0xcf48855c,"Std.string","/home/david/bin/haxe/std/cpp/_std/Std.hx",43,0x66a3cc09)
HX_LOCAL_STACK_FRAME(_hx_pos_fc1982f3765a523e_47_int,"Std","int",0x8fa53b84,"Std.int","/home/david/bin/haxe/std/cpp/_std/Std.hx",47,0x66a3cc09)
HX_LOCAL_STACK_FRAME(_hx_pos_fc1982f3765a523e_51_parseInt,"Std","parseInt",0x90c2ebc7,"Std.parseInt","/home/david/bin/haxe/std/cpp/_std/Std.hx",51,0x66a3cc09)
HX_LOCAL_STACK_FRAME(_hx_pos_fc1982f3765a523e_55_parseFloat,"Std","parseFloat",0xbca10a74,"Std.parseFloat","/home/david/bin/haxe/std/cpp/_std/Std.hx",55,0x66a3cc09)
HX_LOCAL_STACK_FRAME(_hx_pos_fc1982f3765a523e_58_random,"Std","random",0x75a77e8e,"Std.random","/home/david/bin/haxe/std/cpp/_std/Std.hx",58,0x66a3cc09)
...
bool Std_obj::is( ::Dynamic v, ::Dynamic t){
            	HX_STACKFRAME(&_hx_pos_fc1982f3765a523e_26_is)
...
bool Std_obj::isOfType( ::Dynamic v, ::Dynamic t){
            	HX_STACKFRAME(&_hx_pos_fc1982f3765a523e_30_isOfType)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Std_obj,isOfType,return )
 ...
 ::Dynamic Std_obj::downcast( ::Dynamic value,::hx::Class c){
            	HX_STACKFRAME(&_hx_pos_fc1982f3765a523e_34_downcast)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Std_obj,downcast,return )
 ...
 ::Dynamic Std_obj::instance( ::Dynamic value,::hx::Class c){
            	HX_STACKFRAME(&_hx_pos_fc1982f3765a523e_39_instance)
...
::String Std_obj::string( ::Dynamic s){
            	HX_STACKFRAME(&_hx_pos_fc1982f3765a523e_43_string)
...
int Std_obj::_hx_int(Float x){
            	HX_STACKFRAME(&_hx_pos_fc1982f3765a523e_47_int)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Std_obj,_hx_int,return )
 ...
 ::Dynamic Std_obj::parseInt(::String x){
            	HX_STACKFRAME(&_hx_pos_fc1982f3765a523e_51_parseInt)
...
Float Std_obj::parseFloat(::String x){
            	HX_STACKFRAME(&_hx_pos_fc1982f3765a523e_55_parseFloat)
...
int Std_obj::random(int x){
            	HX_STACKFRAME(&_hx_pos_fc1982f3765a523e_58_random)
HXLINE(  59)		if ((x <= 0)) {
HXLINE(  60)			return 0;
            		}
