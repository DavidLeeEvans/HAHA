...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("HAHA", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("HAHA", null, 800, 600);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "4";
		app.meta["company"] = "Cortex Semi";
		app.meta["file"] = "HAHA";
		app.meta["name"] = "HAHA";
		app.meta["packageName"] = "com.davidevans.games.haha";
